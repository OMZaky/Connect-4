...
* **⚙️ Minimax Algorithm:** Implements a robust decision rule used for minimizing the possible loss for a worst-case scenario.
* **🎯 Depth-Aware Scoring Heuristic:** The AI doesn't just look for a win; it optimizes for efficiency. 
  ...
  * **🛡️ Delayed Losses:** If a loss is inevitable, the AI uses a `depth - 10` calculation to prolong the game and force the opponent to work for the win.
